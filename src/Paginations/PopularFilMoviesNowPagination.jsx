...
export default function PopularFilMoviesNowPagination({
  onPageChange,
  setfilMoviesData,
}) {
  ...
  useEffect(() => {
    async function fetchMovies() {
      const res = await fetch(
        `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&with_original_language=tl&primary_release_year=2024&sort_by=popularity.desc&page=${page}`
      );
